                    ...
                    <div class="app-main__inner">
                        ...
                        <div class="">
                            ...
                            <?php                                
                                ...
                                $query = "SELECT * FROM CollegeCompanyDashboard.Companies WHERE id IN (SELECT from_id FROM CollegeCompanyDashboard.Requests WHERE (flag=1 AND to_id=$collegeID)) ORDER BY name";
                                // $query->execute();
                            ...
                            <?php
                                if(isset($_POST['acc']))
                                {
                                    ...
                                    $companyID = (int)$_POST['acc'];
                                    $query = $conn->prepare("INSERT INTO accepted (compId, collId) VALUES (?,?)"); 
                                    $query->bind_param("ii", $companyID, $collegeID);
                                    $query->execute();

                                    $query = $conn->prepare("DELETE FROM CollegeCompanyDashboard.Requests WHERE flag = 1 AND to_id=$collegeID AND from_id=$companyID");
                                    $query->execute();
