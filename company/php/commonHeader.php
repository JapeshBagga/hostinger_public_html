<?php
    require_once "php/identification.php"
?>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                            ...
                                            <a href="user.php" style="text-decoration:none"><button type="button" tabindex="0" class="dropdown-item">User Account</button></a>
                                            <a href="" style="text-decoration:none"><button type="button" tabindex="0" class="dropdown-item">Privacy Policy</button></a>
                                            <a href="" style="text-decoration:none"><button type="button" tabindex="0" class="dropdown-item">Terms & Conditions</button></a>
                                            <a href="settings.php" style="text-decoration:none"><button type="button" tabindex="0" class="dropdown-item">Settings</button></a>
                                            
                                            <button type="button" tabindex="0"
                                                class="dropdown-item">Notifications</button>
                                            <div tabindex="-1" class="dropdown-divider"></div>
                                            <a href="logout.php" style="text-decoration:none"><button type="button" tabindex="0" class="dropdown-item">Log out</button></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="forms-validation.php">
                                    ...
                                    </i>Post Jobs & Internships
                                </a>
                            </li>

                            <li class="app-sidebar__heading">Internships</li>
                            <li>
                                <a href="forms-validation.php">
                            ...
                            <li class="app-sidebar__heading">Connect With Institutes<i class="metismenu-state-icon pe-7s-angle-down caret-left"></i> 
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        <a href="accReq.php">
                                            <i class="metismenu-icon">
                                            </i>Accept College Requests
                                        </a>
                                    </li>
                                    <li>
                                        <a href="recentView.php">
                                            <i class="metismenu-icon">
                            ...
                            <li class="app-sidebar__heading">Add Hr Coordinator</li>
                            <li>
                                <a href="forms-controls.php">
                                    <i class="metismenu-icon pe-7s-mouse">
                                    </i>Add Hr Coordinator
                                </a>
                            </li>
