                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="app-sidebar__heading">Post Internships/Jobs</li>
                            <li>
                                <a href="forms-validation.php">
                                    <i class="metismenu-icon pe-7s-pendrive">
                                    </i>Post Internships/Jobs
                                </a>
                            </li>
                            <li class="app-sidebar__heading">Process</li>
                            <li>
                            ...
                            <li class="app-sidebar__heading">Feedback institute/student</li>
                            <li>
                                <a href="#">
                            ...
                            <li class="app-sidebar__heading">Applicant demographics</li>
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon pe-7s-diamond"></i>
                                    View all applicants
                            ...
                            <!-- <li class="app-sidebar__heading">Connect With Institutes </li>
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon pe-7s-diamond"></i>
