    ...
    <div >
        <div class="container" style="padding-top: 100px">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-md-4 mb-4 mb-md-0 ">
                    <div class="image-container animate__animated animate__fadeInLeft ">
                        <img class="img-fluid" src="images/WelcomeKit.svg" alt="alternative" width="75%">
                    </div> <!-- end of image-container -->
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-md-4 mb-4 mt-4 animate__animated animate__fadeInLeft">
                    <div class="text-container feedback" style="padding-top:-30px; margin-left:200px;">
                        ...
                        <div class="text-justify" >
                        <div class="media-body text-dark " style="padding-top:10px;">&#9672;&nbsp;&nbsp;Login To the Account</div>
                        
                    
                        <div class="media-body text-dark" style="padding-top:10px;">&#9672;&nbsp;&nbsp;Update the company Profile</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-md-4 mb-4 mb-md-0 animate__animated animate__fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-md-4 mb-4 mb-md-0 ">
                    <div class="image-container animate__animated animate__fadeInLeft " style="margin-left:100px;width:75%; ">
                        <img class="img-fluid" src="images/undraw_Wall_post_re_y78d.svg" alt="alternative" width="80%">
                    </div> <!-- end of image-container -->
                </div>
                <div class="col-lg-6 col-md-6 col-md-4 mb-4 mt-4" >
                    <div class="text-container animate__animated animate__fadeInRight">
                        <h2>STEP 4 : Post Job/Internship Offers</h2>
                        
                        <div class="text-justify" >
                        <div class="media-body text-dark" style="padding-top:10px;">&#9672;&nbsp;&nbsp;Post Job/Internship offers in your profile</div>
                        <div class="media-body text-dark " style="padding-top:10px;">&#9672;&nbsp;&nbsp;Provide detailed description about the offer including job title,designation etc.</div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-md-4 mb-4 mt-4 animate__animated animate__fadeInLeft">
                  <div class="text-container feedback"style="padding-top:-30px; margin-left:200px;">
                      <h2>STEP 5 : Connect with Colleges</h2>
                      <div class="text-justify" >
                      <div class="media-body text-dark" style="padding-top:10px;">&#9672;&nbsp;&nbsp;View the profiles of different institutes</div>
                      <div class="media-body text-dark " style="padding-top:10px;">&#9672;&nbsp;&nbsp;Connect with Coordinators</div>
                      <div class="media-body text-dark " style="padding-top:10px;">&#9672;&nbsp;&nbsp;Students will be able to apply to your offers</div>
              ...
              <div class="col-lg-6 col-md-6 col-md-4 mb-4 mb-md-0 animate__animated animate__fadeInRight">
                  <div class="image-container" style="margin-right:200px; ">
                      <img class="img-fluid" src="images/undraw_geniuses_9h9g.svg" alt="alternative">
                  </div> <!-- end of image-container -->
              </div>
          </div>
          ...
          <div class="row">
                <div class="col-lg-6 col-md-6 col-md-4 mb-4 mb-md-0 ">
                    <div class="image-container animate__animated animate__fadeInLeft " style="margin-left:100px;width:75%; ">
                        <img class="img-fluid" src="images/undraw_Hiring_re_yk5n.svg" alt="alternative" width="70%" style="margin-left: 50px;">
                    </div> <!-- end of image-container -->
                </div>
                <div class="col-lg-6 col-md-6 col-md-4 mb-4 mt-4" >
                    <div class="text-container animate__animated animate__fadeInRight">
                        <h2>STEP 6 : Select the candidate</h2>
                        
                        <div class="text-justify" >
                        <div class="media-body text-dark" style="padding-top:10px;">&#9672;&nbsp;&nbsp;Filter the applications based on desired skill set.</div>
                        <div class="media-body text-dark " style="padding-top:10px;">&#9672;&nbsp;&nbsp;Conduct the interview process</div>
                        <div class="media-body text-dark" style="padding-top:10px;">&#9672;&nbsp;&nbsp;Select the right Candidate for the job offer</div>
                        </div>
                    </div>
                    </div>
                    </p>
