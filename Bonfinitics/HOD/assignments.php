                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12"> 
											<div class="form-select-list">
												<select class="form-control custom-select-value" name="assign-subject">
												<?php
                            ...
                            <div id="summernote2">
                                <div class="note-editable panel-body" contenteditable="true" style="height: 200px;">
                                    <p style="font-size: 14px; line-height: 24px;">
										<span name="assign-data" style="color: rgb(0, 0, 0);">Question 1</span>
									</p>
                                </div>
                            </div>
                                        ...
                                        <div class="file-upload-inner file-upload-inner-right ts-forms">
                                            <div class="input append-big-btn">
                                                ...
                                                <div class="file-button">
                                                    Browse
                                                    <input type="file" name="assign-file" onchange="document.getElementById('append-big-btn').value = this.value;">
                                                </div>
