...
<?php
	$sub_query = "select subject_name,subject_dept,subject_student from subject 
	where (subject_name LIKE '%".$_POST['name']."%' or subject_dept LIKE '%".$_POST['name']."%' or subject_student LIKE '%".$_POST['name']."%')";
