...
<head>
    ...
    <title>Add Department | BonFinitics - Makos</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                 <form id="add-department" action="insert-department.php" method="post" class="form add-department">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="form-group">
                                                                <input name="dept_code" type="text" class="form-control" placeholder="Department Code">
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="dept_hod" type="text" class="form-control" placeholder="Head of Department">
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <input name="dept_phone" type="number" class="form-control" placeholder="Phone">
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="dept_email" type="email" class="form-control" placeholder="Email">
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="no_of_sem" type="number" class="form-control" placeholder="No. of Semesters">
                                                            </div>
