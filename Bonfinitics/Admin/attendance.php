                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Faculty Attendance <span class="table-project-n"></span> </h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-editable="true" data-field="professorname">Professor Name</th>
                                                <!-- <th data-field="name">Subject Name</th> -->
                                                <th data-field="email">Department</th>
                                                <!-- <th data-field="task">Timing</th> -->
                                                <th data-field="Present">No. Of Days Present</th>
                                        ...
                                        <tbody>
                                           <?php
											...
											$atd_query = "select atd_faculty_name,atd_dept,atd_present_days,atd_absent_days,atd_total_days from attendance where atd_type='faculty'";
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <!-- <th data-field="id">S.No.</th> -->
                                                <!-- <th data-field="complete">Completed</th> -->
                                                <th data-field="sname" data-editable="true" >Student Name</th>
                                                <!-- <th data-field="name" >Subject Name</th> -->
                                                <th data-field="email" >Department</th>
                                                <!-- <th data-field="task" >Timing</th> -->
                                                <th data-field="Present">No. Of Days Present</th>
                                        ...
                                        <tbody>
										<?php
											$atd_query = "select atd_student_name,atd_dept,atd_present_days,atd_absent_days,atd_total_days from attendance where atd_type='student'";
											$atd_query_result = mysqli_query($conn,$atd_query);
											while($row=mysqli_fetch_array($atd_query_result)){
										?>
                                            <tr>
