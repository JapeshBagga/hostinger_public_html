        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <!-- <li>
                        <a title="Quizes Summary" href="quizes.php" aria-expanded="false"><span class="educate-icon educate-message icon-wrap" aria-hidden="true"></span> <span class="mini-click-non">Quizes</span></a>
                    </li> -->
                    <!-- <li> 
                        <a class="has-arrow" title="Assignments" href="all-assignment.php" aria-expanded="false"><span class="educate-icon educate-message icon-wrap"></span> <span class="mini-click-non">Assignments</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="All Assignments" href="assignment-list.php"><span class="mini-sub-pro">Assignment List</span></a></li>
                            <li><a title="Add-Assignment" href="add-assignment.php" href="add-subject-info.php"><span class="mini-sub-pro">Add-Assignment</span></a></li>
                    ...
                    <!-- <li> 
                        <a title="Assignments" href="add-assignment.php" aria-expanded="false"><span class="educate-icon educate-message icon-wrap" aria-hidden="true"></span> <span class="mini-click-non">Assignments</span></a>
                    </li> -->
                    <!-- <li>
                        <a title="Exam" href="exam.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap"  aria-hidden="true"></span> <span class="mini-click-non">Exam</span></a>
                    </li> -->
