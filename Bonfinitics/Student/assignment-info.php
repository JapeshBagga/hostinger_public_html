...
<head>
    ...
    <title>Assignment | BonFinitics - Makos</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Assignment Info</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <script >
        const quizData = [
            ...
            if (answer) {
                ...
                quiz.innerHTML = `<h4>You answered correctly ${score}/${quizData.length} questions. You really know your Subject! Great Job!</h4> <button onclick="subject-info.php">Okay</button>`;
                } else {
                quiz.innerHTML = `<h4>You answered only correctly ${score}/${quizData.length} questions. Keep Studying more, you need more improvement! </h4> <button onclick="subject-info.php">Okay</button>`;
                }
            }
            });
