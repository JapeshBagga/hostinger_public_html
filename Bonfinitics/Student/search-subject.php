...
<?php
	$sub_query = "select subject_name,subject_dept,subject_student,subject_professor from subject 
	where (subject_name LIKE '%".$_POST['name']."%' or subject_dept LIKE '%".$_POST['name']."%' or subject_student LIKE '%".$_POST['name']."%' or subject_professor LIKE '%".$_POST['name']."%')";
	...
	<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
		<div class="courses-inner res-mg-b-30">
			...
			<div class="product-buttons">
				<a href="subject-info.php"><button type="button" class="button-default cart-btn"> Read More</button></a>
			</div>
		</div>
	</div>
<?php
